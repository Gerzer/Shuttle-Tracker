...
class Stop: NSObject, Decodable, Identifiable, CustomAnnotation {
	...
	let annotationView: MKAnnotationView = {
		...
		#if canImport(AppKit)
		annotationView.image = NSImage(systemSymbolName: SFSymbols.busStop.rawValue, accessibilityDescription: nil)?
			.withTintColor(.white)
		...
		let image = UIImage(systemName: SFSymbols.busStop.rawValue)!
